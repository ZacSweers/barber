...
/**
 * A weak ArraySet. An element stored in the WeakArraySet might be
 * garbage collected, if there is no strong reference to this element.
 */

@SuppressWarnings("unused")
public class WeakArraySet extends ArraySet {
    /**
    ...
    public Iterator iterator() {
        ...
        // get an iterator of the superclass WeakArraySet
    ...
    /**
     * A WeakArraySet stores objects of class WeakElement.
     * A WeakElement wraps the element that should be stored in the WeakArraySet.
